odoo.define('mrp.mrp_bom_report', function (require) {
    ...
    var MrpBomReport = stock_report_generic.extend({
        ...
        get_html: function () {
            ...
            return this._rpc({
                model: 'report.mrp_bom_structure_report.report_bom_structure',
                method: 'get_html',
                args: args,
            })
        ...
        _onClickPrint: function (ev) {
            ...
            framework.blockUI();
            var reportname = 'mrp_bom_structure_report.report_bom_structure?docids=' + this.given_context.active_id + '&report_type=' + this.given_context.report_type;
            ...
            var action = {
                ...
                'report_file': 'mrp_bom_structure_report.report_mrp_bom_pdf',
            };
        ...
        _removeLines: function ($el) {
            ...
            _.each(this.$('tr[parent_id='+ activeID +']'), function (parent) {
                ...
                $el = self.$('tr[parent_id='+ $parent.data('id') +']');
                if ($el.length) {
