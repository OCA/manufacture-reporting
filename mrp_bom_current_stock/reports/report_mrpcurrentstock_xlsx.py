...
class ReportMrpBomCurrentStockXlsx(models.AbstractModel):
    ...
    def _print_bom_children(ch, sheet, row):
        ...
        sheet.write(i, 4, ch.product_uom_id.name or '')
        sheet.write(i, 5, ch.location_id.name or '')
        sheet.write(i, 6, ch.qty_available_in_source_loc or 0.0)
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        for o in objects:
            ...
            sheet.write(i, 5, o.location_id.name or '', bold)
